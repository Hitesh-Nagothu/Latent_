...
def get_tweets(query):
    ...
    inurl = 'http://3.84.185.191:8983/solr/Twitter/select?defType=dismax&fl=user.name%2Cid%2Cscore' \
...
app.layout = html.Div([
        ...
        dbc.Row(
            ...
            dbc.Col(
                    html.Div(children=[dcc.Input(id="input1", value="", type="text", placeholder="Enter Query here and click on Submit",style=dict(width='85%'), debounce=True)],
                    style={'display': 'inline-block', 'vertical-align': 'top', 'justifyContent': 'center', 'text-align': 'center', 'margin-left': '3vw','margin-top': '3vw'}), width={"size": 10, "offset": 5},
        ...
        dbc.Row(
            ...
            dbc.Col(
                # second block
                html.Div(children=[html.Div(id='container')],
                         style={'display': 'inline-block', 'vertical-align': 'top', 'margin-left': '3vw',
                                'margin-top': '3vw'}), width={"size": 10, "offset": 5},
        ...
        dbc.Row(
                dbc.Col(
                    #3 block second-half
                    html.Div( children = [html.Div(id='news')], style={'display': 'inline-block', 'vertical-align': 'top', 'margin-left': '3vw','margin-top': '3vw'}),
